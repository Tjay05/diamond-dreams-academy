    ...
    <div className="relative">
      ...
      >
        ...
        <div className="relative z-1 flex flex-col items-center justify-center rule py-4">
          ...
          <button className="rounded uppercase text-center w-full font-bold font-[Open_Sans] text-lg text-[#5c0002] p-2 my-6 bg-white hover:cursor-pointer">Courses</button>
        </div>
      </header>
      ...
      <section className="rule pt-56 pb-6">
        <img className="rounded-md w-full my-4" src={handbag} alt="" />
        <p className="my-2 tracking-widest font-[rokkitt] text-[#5c0002] font-medium">Who We Are</p>
        <h2 className="font-bold font-[rokkitt] my-3 text-3xl">Your one-stop guide for Career transformation</h2>
        <p className="font-[Open_sans] text-black my-2">
      ...
      >
        ...
        <div className="relative z-1 flex flex-col items-center justify-center text-white rule py-4">
          <h2 className="font-bold text-3xl my-4 text-center font-[rokkitt]">Our Courses</h2>
          <p className="text-center text-lg font-[Open_sans] my-2">
          ...
          <button className="uppercase rounded py-2 w-full font-bold text-black bg-[#9d5808] hover:cursor-pointer my-3">courses</button>
        </div>
      </section>
      <section className="rule py-6">
        <p className="mt-2 tracking-widest font-[rokkitt] text-[#5c0002] font-medium text-center">What We Offer</p>
        <h2 className="font-[rokkitt] text-3xl font-bold text-center">What You Get</h2>
        {/* Courses Displayed */}
        <div className="">
      ...
      {/* Summary */}
      <section 
        className="relative w-full bg-center bg-cover py-4"
        style={{ backgroundImage: `url(${laptop})` }}
      >
        <div className="absolute inset-0 opacity-85 bg-black"></div>
        <div className="relative flex w-3/4 mx-auto font-[rokkitt] justify-between">
          <div className="flex flex-col my-4 items-center">
            <p className="text-5xl font-bold text-center text-white">30+</p>
            <p className="text-xl font-bold text-[#9d5808] text-center">Students</p>
          </div>
          <div className="flex flex-col my-4 items-center">
            <p className="text-5xl font-bold text-center text-white">10+</p>
            <p className="text-xl font-bold text-[#9d5808] text-center">Courses</p>
          </div>
        </div>
        <div className="relative flex w-3/4 mx-auto font-[rokkitt] justify-between">
          <div className="flex flex-col my-4 items-center">
            <p className="text-5xl font-bold text-center text-white">15+</p>
            <p className="text-xl font-bold text-[#9d5808] text-center">Topics</p>
          </div>
          <div className="flex flex-col my-4 items-center">
            <p className="text-5xl font-bold text-center text-white">50+</p>
            <p className="text-xl font-bold text-[#9d5808] text-center">Reviews</p>
          </div>
        </div>
      </section>
    </div>
